...
```bash
npm install --global tweeter-client@^4.0.1
```
...
```bash
yarn global add tweeter-client@^4.0.1
```
...
```bash
npm install --global @jaid/tweeter-client@^4.0.1
```
