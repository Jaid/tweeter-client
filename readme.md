...
```bash
npm install --global tweeter-client@^4.13.0
```
...
```bash
yarn global add tweeter-client@^4.13.0
```
...
```bash
npm install --global @jaid/tweeter-client@^4.13.0
```
